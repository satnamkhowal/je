                        ...
                        <div class="row y-middle">
                            ...
                            <div class="col-md-7 text-right">
                                    <ul class="toolbar-sl-share">
                                        <li class="opening"> <i class="flaticon-location"></i> 374 William S Canning Blvd, MA 2721, USA </li>
                                        <li><a href="index14.html#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="index14.html#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="index14.html#"><i class="fa fa-linkedin"></i></a></li>
                                        <li><a href="index14.html#"><i class="fa fa-instagram"></i></a></li>
                                    </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row y-middle">
                                      ...
                                      <nav class="rs-menu">
                                         <ul class="nav-menu">
                                            <li class="rs-mega-menu mega-rs menu-item-has-children current-menu-item"> <a href="index.html">Home</a>
                                                        ...
                                                        <div class="mega-menu-innner">
                                                            ...
                                                            <div class="single-megamenu">
                                                                <ul class="sub-menu last-sub-menu">
                                                                    ...
                                                                    <li class="active"><a href="index14.html">Courses Archive</a> </li>
                                             ...
                                             <li class="menu-item-has-children">
                                                 <a href="index14.html#">Pages</a>
                                                 <ul class="sub-menu">
                                                     <li class="menu-item-has-children right">
                                                         <a href="index14.html#">Team</a>
                                             ...
                                             <li class="menu-item-has-children">
                                                 <a href="index14.html#">Blog</a>
                                                 <ul class="sub-menu">
                                                     <li><a href="blog.html">Blog</a></li>
                                                     <li class="menu-item-has-children">
                                                         <a href="index14.html#">Blog Sidebar</a>
                                                         <ul class="sub-menu right">
                                                     ...
                                                     <li class="menu-item-has-children">
                                                         <a href="index14.html#">Single Post</a>
                                                         <ul class="sub-menu right">
                            ...
                            <div class="col-lg-2 text-right">
                                <div class="expand-btn-inner">
                                    <ul>
                                        <li>
                                            <a class="hidden-xs rs-search" data-target=".search-modal" data-toggle="modal" href="index14.html#">
                                                <i class="flaticon-search"></i>
                                            </a>
                                        </li>
                                        <li class="user-icon cart-inner no-border mini-cart-active">
                                            <a href="index14.html#"><i class="fa fa-shopping-bag"></i></a>
                                            <div class="woocommerce-mini-cart text-left">
                                                <div class="cart-bottom-part">
                                                    <ul class="cart-icon-product-list">
                                                        <li class="display-flex">
                                                            <div class="icon-cart">
                                                                <a href="index14.html#"><i class="fa fa-times"></i></a>
                                                            </div>
                ...
                <nav class="right_menu_togle hidden-md">
                    ...
                    <div class="canvas-contact">
                        <ul class="social">
                            <li><a href="index14.html#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="index14.html#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="index14.html#"><i class="fa fa-pinterest-p"></i></a></li>
                            <li><a href="index14.html#"><i class="fa fa-linkedin"></i></a></li>
                        </ul>
                    </div>
                </nav>
